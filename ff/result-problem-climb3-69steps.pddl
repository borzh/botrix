(define (problem bots)
	...
	(:init
        ...
        (toggle button1 door8 door9)
        (toggle button10 door6 door9)
        (toggle button2 door10 door3)
        (toggle button3 door3 door6)
        (toggle button4 door2 door8)
        (toggle button5 door2 door3)
        (toggle button6 door8 door2)
        (toggle button7 door10 door7)
        (toggle button8 door6 door4)
        (toggle button9 door5 door2)
