...
namespace good
{
	...
	public:
		...
		public:
			...
			/// Pre-increment.
			iterator& operator++() { DebugAssert(m_pCurrent); m_pCurrent = m_pCurrent->next; return *this; }
			/// Pre-decrement.
			iterator& operator--() { DebugAssert(m_pCurrent); m_pCurrent = m_pCurrent->prev; return *this; }

			/// Post-increment.
			iterator operator++(int) { DebugAssert(m_pCurrent); iterator tmp(*this); m_pCurrent = m_pCurrent->next; return tmp; }
			/// Post-decrement.
			iterator operator--(int) { DebugAssert(m_pCurrent); iterator tmp(*this); m_pCurrent = m_pCurrent->prev; return tmp; }
